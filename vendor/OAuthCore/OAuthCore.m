...
NSString *OAuthorizationHeader(NSURL *url, NSString *method, NSData *body, NSString *_oAuthConsumerKey, NSString *_oAuthConsumerSecret, NSString *_oAuthVerifier, NSString *_oAuthToken, NSString *_oAuthTokenSecret)
{
    ...
    NSMutableString *key = [NSMutableString stringWithFormat:@"%@&", [_oAuthConsumerSecret ab_RFC3986EncodedString]];
    if (_oAuthTokenSecret) {
        [key appendFormat:@"%@", [_oAuthTokenSecret ab_RFC3986EncodedString]];
    }
